      ...
      <section className="pt-32 pb-20 px-4 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            India&apos;s <span className="text-yellow-400">#1 AI-Powered</span>{" "}
            Platform for Government Schemes & Digital Services
          </h1>
          <p className="text-lg md:text-xl text-gray-300 mb-8 leading-relaxed">
            DigiNxt आपको सही government scheme, loan, subsidy और digital
            services एक ही platform पर provide करता है — fast, easy और भरोसेमंद।
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link
              href="/scheme-finder"
              className="bg-yellow-400 text-black px-8 py-4 rounded-lg font-bold text-lg hover:bg-yellow-300 transition transform hover:scale-105"
            >
              Check Eligibility (Free)
            </Link>
            <Link
              href="/services"
              className="border-2 border-yellow-400 text-yellow-400 px-8 py-4 rounded-lg font-bold text-lg hover:bg-yellow-400 hover:text-black transition"
            >
              Explore Services
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {highlights.map((h, i) => (
              <div
                key={i}
                className="bg-gray-900 p-6 rounded-lg border border-yellow-400"
              >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {whyChoose.map((item, i) => (
              <div
                key={i}
                className="flex items-center gap-4 p-6 bg-black rounded-lg border border-yellow-400"
              >
      ...
      <section className="py-20 px-4 bg-black text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-gray-300 mb-8 text-lg">
            Let AI help you find the perfect government scheme and digital
